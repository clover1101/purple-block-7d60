...
```
npm create cloudflare@latest -- --template=cloudflare/templates/purple-block-7d60
```

A live public deployment of this template is available at [https://purple-block-7d60.templates.workers.dev](https://purple-block-7d60.templates.workers.dev)
